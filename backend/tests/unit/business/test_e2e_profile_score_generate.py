...
def test_profile_to_score_to_generate_flow(tmp_path, monkeypatch):
    import main
    from api.dependencies import get_generation_service, get_job_runner, get_profile_service, get_ranking_service, get_repository
    ...
    monkeypatch.setattr(discovery, "get_job_store", lambda: job_store)
    previous, sentinel = _install_overrides(main.app, {
        ...
        get_job_runner: lambda: job_store,
    })
