...
def test_scheduler_ghost_tick_cancels_when_profile_has_no_targets(monkeypatch):
    import automation.ghost as scheduler
    ...
    monkeypatch.setattr(scheduler, "_default_repo", lambda: repo)
    monkeypatch.setattr(scheduler, "get_job_store", lambda: job_store)
    monkeypatch.setattr(scheduler, "_default_automation_service", lambda _repo: object())
    monkeypatch.setattr(scheduler, "_default_discovery_service", lambda: object())
    monkeypatch.setattr(scheduler, "_default_generation_service", lambda: object())
    monkeypatch.setattr(scheduler, "_default_ranking_service", lambda: object())
