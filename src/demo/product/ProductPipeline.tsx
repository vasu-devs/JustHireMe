...
export function ProductPipeline({ jobs, onSelect, onMove }: { jobs: DemoJob[]; onSelect: (job: DemoJob) => void; onMove: (id: number, stage: DemoJob["stage"]) => void }) {
  ...
  return <div className="pipeline-view product-enter">
    ...
    <div className="pipeline-summary"><span><i />8 active roles</span><span><mark className="diary-highlight pink">3 ready for review</mark></span><span>2 follow-ups due</span><button>Board <kbd>B</kbd></button><button>List <kbd>L</kbd></button></div>
