...
| ATS connectors (Greenhouse/Lever/Ashby/Workable) + RSS/API boards (RemoteOK/Remotive/Jobicy/WeWorkRemotely) + HN/GitHub/Reddit | [test_discovery_sources.py](../backend/tests/test_discovery_sources.py), [test_regression_discovery_sources.py](../backend/tests/test_regression_discovery_sources.py) |
